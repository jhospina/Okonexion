...
class Lang_ES {
    ...
    const LOGIN_FORM_SEND_EMAIL_CONFIRMATION = "Hemos enviado un mensaje a tu correo electrónico <b>:email</b> con un enlace para activar tu cuenta.</br> ¡Revisalo por favor!";
    const LOGIN_FORM_MSJ_FAIL_CONFIRMATION = "Lo sentimos, no puedes ingresar a esta cuenta porque no ha sido activada. Para activarla debes confirmar tu correo electrónico ingresando en el enlace que te enviamos a tu correo <b>:email</b> al momento del registro.<br/><a href=':link'>¿Reenviar enlace de activación?</a>";
    ...
    const LOGIN_FORM_MSJ_RECOVERY_PASSWORD = "<h1>¡TU CONTRASEÑA HA SIDO REESTRABLECIDA!</h1><h2>Ya puedes iniciar sesión con tu nueva contraseña</h2>";
