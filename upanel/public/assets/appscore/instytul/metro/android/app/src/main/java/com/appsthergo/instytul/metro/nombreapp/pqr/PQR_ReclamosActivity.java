...
public class PQR_ReclamosActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        App.establecerBarraAccion(this, App.txt_menuBtn_4+" - "+App.txt_info_pqr_reclamos);

        apariencia();

        PQR pqr=new PQR(this);
        pqr.cargarContenido(R.id.lay_cargar_contenido_pqr,PQR.TIPO_RECLAMO);
    ...
    public void apariencia(){
        ...
        btn_crear.setBackground(fondoBtn);btn_crear.setText(App.txt_info_btn_crear_reclamo);
        btn_crear.setTextColor(Color.parseColor(App.txt_menuBtn_4_color));

        //TITULO "MIS reclamos"
        TextView mis_reclamos=(TextView)findViewById(R.id.txt_pqr_tipo);
        mis_reclamos.setText(App.txt_info_mis_reclamos);
        mis_reclamos.setBackground(new ColorDrawable(Color.parseColor(App.colorBarraApp)));
        mis_reclamos.setTextColor(Color.parseColor(App.colorNombreApp));
        ...
        btn_crear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayList views=pqr.cargarFormularioCreacion(R.id.lay_cont_form_crear_pqr, App.txt_info_editText_descripcion_reclamo);
                ...
                btn_enviar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(!Conexion.verificar(PQR_ReclamosActivity.this))
                        {
                            Mensaje.alerta(PQR_ReclamosActivity.this, App.txt_info_titulo_sin_conexion, App.txt_info_descripcion_sin_conexion, null);
                            return;
                        }

                        if(txt_nombre.length()<5){
                            Mensaje.alerta(PQR_ReclamosActivity.this,App.txt_info_error,App.txt_info_nombre_error);
                            return;
                        }
                        ...
                        {
                            Mensaje.alerta(PQR_ReclamosActivity.this,App.txt_info_error,App.txt_info_email_error);
                            return;
                        }

                        if(txt_asunto.length()<5){
                            Mensaje.alerta(PQR_ReclamosActivity.this,App.txt_info_error,App.txt_info_asunto_error);
                            return;
                        }

                        if(txt_descripcion.length()<5){
                            Mensaje.alerta(PQR_ReclamosActivity.this,App.txt_info_error,App.txt_info_descripcion_error);
                            return;
                        }


                        ProgressDialog dialog = new ProgressDialog(PQR_ReclamosActivity.this);
                        dialog.setMessage(App.txt_info_enviando);
                        dialog.show();
                        ComunicacionPQR com = new ComunicacionPQR(PQR_ReclamosActivity.this, dialog, ComunicacionPQR.Dir.enviar,PQR.TIPO_RECLAMO,R.id.lay_cargar_contenido_pqr);
