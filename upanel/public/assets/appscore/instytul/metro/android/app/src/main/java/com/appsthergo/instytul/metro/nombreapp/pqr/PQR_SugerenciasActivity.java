...
public class PQR_SugerenciasActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pqr.cargarContenido(R.id.lay_cargar_contenido_pqr,PQR.TIPO_SUGERENCIA);
    ...
    public void apariencia(){
        ...
        TextView mis_sugerencias=(TextView)findViewById(R.id.txt_pqr_tipo);
        mis_sugerencias.setText(App.txt_info_mis_sugerencias);
        mis_sugerencias.setBackground(new ColorDrawable(Color.parseColor(App.colorBarraApp)));
        mis_sugerencias.setTextColor(Color.parseColor(App.colorNombreApp));
                ...
                btn_enviar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(txt_nombre.length()<5){
                            Mensaje.alerta(PQR_SugerenciasActivity.this,App.txt_info_error,App.txt_info_nombre_error);
                            return;
                        }
                        ...
                        {
                            Mensaje.alerta(PQR_SugerenciasActivity.this,App.txt_info_error,App.txt_info_email_error);
                            return;
                        }

                        if(txt_asunto.length()<5){
                            Mensaje.alerta(PQR_SugerenciasActivity.this,App.txt_info_error,App.txt_info_asunto_error);
                            return;
                        }

                        if(txt_descripcion.length()<5){
                            Mensaje.alerta(PQR_SugerenciasActivity.this,App.txt_info_error,App.txt_info_descripcion_error);
                            return;
                        }
