...
<table class="table table-striped">
    <tr><th>Tipo de soporte</th><td>{{ Form::select('tipo',array("Elegir"=>"Elegir",Ticket::TIPO_GENERAL=>"General",Ticket::TIPO_COMERCIAL=>"Comercial",Ticket::TIPO_FACTURACION=>"Facturación",Ticket::TIPO_TECNICO=>"Técnico"), null, array('class' => 'form-control')) }}</td></tr>
...
<div class="well-lg text-right">
    {{ Form::button("<span class='glyphicon glyphicon-plus glyphicon-ok-circle'></span> Crear ticket", array('type' => 'submit', 'class' => 'btn btn-primary',"id"=>"btn-crear")) }} 
    {{ Form::close() }}
</div>
@stop
...
<script>
    jQuery(document).ready(function () {
        ...
        jQuery("#btn-crear").click(function () {
            jQuery(this).html("<span class='glyphicon glyphicon-refresh glyphicon-refresh-animate'></span> Creando...");
