...
<div class="col-lg-12" style="margin-bottom: 30px;">
    <form method="POST" id="form">
        <div class="col-lg-12" style="margin-bottom: 20px;">
            <div class="col-lg-12"><input name="{{$tituloID}}" type="text"  placeholder="Introduce el titulo aquí" class="form-control input-lg"></div>
            <div class="col-lg-12">
                <div id="editor"></div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="content-cats">
                        ...
                        <div class="checkbox" style="margin: 0px;">
                            <label><input type="checkbox" name="cat-{{$cat->id}}" value="{{$cat->id}}"/> {{$cat->nombre}}</label>
                        </div>
                        @endforeach
                    </div>
