...
<h2><span class="glyphicon {{Contenido_Encuestas::icono}}"></span> {{trans("otros.info.agregar")}} {{$singNombre}}</h2>
<hr/>
...
<form id="form" method="POST">
    ...
    <div class="col-lg-12">
        <input class="form-control input-lg" id="{{Contenido_Encuestas::configTitulo}}" name="{{Contenido_Encuestas::configTitulo}}" placeholder="{{trans('app.admin.encuestas.info.titulo.placeholder')}}">
    </div>

    <div class="col-lg-10">
        <textarea class="form-control" style="display:none;margin-top: 5px;" name="{{Contenido_Encuestas::configDescripcion}}" placeholder="{{trans('app.admin.encuestas.info.descripcion.placeholder')}}"></textarea>
    </div>
        ...
        <div class="col-lg-12"> 
            <div class="col-lg-9" id="content-respuestas"> 
                <div class="col-lg-12 item set" id="item-1"> 
                    ...
                    <div class="col-lg-10 div-resp"><input id="{{Contenido_Encuestas::configRespuesta}}1" class="form-control resp" data-item="1" name="{{Contenido_Encuestas::configRespuesta}}[]" placeholder="{{trans("app.admin.encuestas.info.respuestas.placeholder")}}" value=""></div>
