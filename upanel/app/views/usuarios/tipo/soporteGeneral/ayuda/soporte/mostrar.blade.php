...
<div class="block">
    ...
    <div class="container" id="content-form">
        {{Form::model(null,array('route' => array('soporte.update', $ticket->id),'method' => 'put','enctype' => 'multipart/form-data','rol' => 'form'),array('role' => 'form')) }}
        ...
        <div class="col-lg-8">
            ...
            <div class="col-lg-6 text-right" style="padding: 0px;margin-top: 10px;">{{ Form::button("<span class='glyphicon glyphicon-plus glyphicon-ok-circle'></span> Enviar", array('type' => 'submit', 'class' => 'btn btn-primary')) }} </div>
        </div>
    ...
    <div class="col-lg-6">
        ...
        @else  
        <span class="glyphicon glyphicon-comment" style="color:red;"></span>  <span style="color:red">{{$usuario_cliente->nombres}} // Soporte </span>
        @endif 
    </div>
