...
class App_Instytul_Metro {
    ...
    public static function plantillaConfigAndroid($config) {
        ...
        foreach ($datos as $indice => $valor) {            
            $java_config.=(strpos($indice,"modulo_")!==false)?"public static boolean $indice=".HtmlControl::setBoolean(Util::convertirIntToBoolean($valor)).";\n":"public static String $indice=\"$valor\";\n";
        }
    ...
    public static function prepararArchivosParaAndroid($zip, $config, $ruta) {
        ...
        for ($i = 1; $i <= count($iconos); $i++) {
            ...
            if (filter_var($config[$iconos[$i - 1]], FILTER_VALIDATE_URL)) {
                ...
                $imagen->crearCopia($dim_web, $dim_web, "img_menu_btn_" . $i . "-web", $ruta . "app/src/main/", false);
                $zip->addFile($ruta . "app/src/main/" . "img_menu_btn_" . $i . "-web." . $imagen->getExtension(), "app/src/main/img_menu_btn_" . $i . "-web.png");
                //mipmap-xxxhdpi
                $imagen->crearCopia($dim_xxxhdpi, $dim_xxxhdpi, "img_menu_btn_" . $i, $ruta . "app/src/main/res/mipmap-xxxhdpi/", false);
                $zip->addFile($ruta . "app/src/main/res/xxxhdpi/" . "img_menu_btn_" . $i . "." . $imagen->getExtension(), "app/src/main/res/mipmap-xxxhdpi/img_menu_btn_" . $i . ".png");
                //mipmap-xxhdpi
                $imagen->crearCopia($dim_xxhdpi, $dim_xxhdpi, "img_menu_btn_" . $i, $ruta . "app/src/main/res/mipmap-xxhdpi/", false);
                $zip->addFile($ruta . "app/src/main/res/xxhdpi/" . "img_menu_btn_" . $i . "." . $imagen->getExtension(), "app/src/main/res/mipmap-xxhdpi/img_menu_btn_" . $i . ".png");
                //mipmap-xhdpi
                $imagen->crearCopia($dim_xhdpi, $dim_xhdpi, "img_menu_btn_" . $i, $ruta . "app/src/main/res/mipmap-xhdpi/", false);
                $zip->addFile($ruta . "app/src/main/res/xhdpi/" . "img_menu_btn_" . $i . "." . $imagen->getExtension(), "app/src/main/res/mipmap-xhdpi/img_menu_btn_" . $i . ".png");
                //mipmap-hdpi
                $imagen->crearCopia($dim_hdpi, $dim_hdpi, "img_menu_btn_" . $i, $ruta . "app/src/main/res/mipmap-hdpi/", false);
                $zip->addFile($ruta . "app/src/main/res/hdpi/" . "img_menu_btn_" . $i . "." . $imagen->getExtension(), "app/src/main/res/mipmap-hdpi/img_menu_btn_" . $i . ".png");
                //mipmap-mdpi
                $imagen->crearCopia($dim_mdpi, $dim_mdpi, "img_menu_btn_" . $i, $ruta . "app/src/main/res/mipmap-mdpi/", false);
                $zip->addFile($ruta . "app/src/main/res/mdpi/" . "img_menu_btn_" . $i . "." . $imagen->getExtension(), "app/src/main/res/mipmap-mdpi/img_menu_btn_" . $i . ".png");
            } else {
